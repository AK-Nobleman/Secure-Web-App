...
--
-- Table structure for table `usable_photo`
--

CREATE TABLE `usable_photo` (
  `id` int(11) NOT NULL,
  `image_name` varchar(255) NOT NULL,
  `image_path` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Dumping data for table `usable_photo`
--

INSERT INTO `usable_photo` (`id`, `image_name`, `image_path`) VALUES
(0, 'AC', 'images/AC 1.png'),
(0, 'Camera 1', 'images/Camera 1.png'),
(0, 'Camera 2', 'images/Camera 2.png'),
(0, 'Door Lock 1', 'images/Door Lock 1.png'),
(0, 'Fridge 1', 'images/Fridge 1.png'),
(0, 'Fridge 2', 'images/Fridge 2.png'),
(0, 'Garage 1', 'images/Garage 1.png'),
(0, 'Light Switch 1', 'images/Light Switch 1.png'),
(0, 'TV 1', 'images/TV1.png');
...
--
ALTER TABLE `device`
  ADD CONSTRAINT `device_ibfk_1` FOREIGN KEY (`family_id`) REFERENCES `head` (`family_id`);
